...
export const MagicWandIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m19 2 2 2-2 2-2-2 2-2Z"/><path d="m5 6 2 2-2 2-2-2 2-2Z"/><path d="m15 11-5 5-2.9-2.9a1 1 0 0 0-1.4 1.4l3.6 3.6a1 1 0 0 0 1.4 0l5.7-5.7a1 1 0 0 0 0-1.4l-1.4-1.4a1 1 0 0 0-1.4 0Z"/></svg>
);
